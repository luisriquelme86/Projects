...
public class Acceso {
    ...
    // porque uso linked list? Cual es la explicacion?
    ...
    // para que se usa sumador? Porque tiene este valor y no otro?
    ...
    public void atender() {
        ...
        // Hace un remove... de donde remueve de atras o de adelante? Cual es la logica de estas colas?
        colaEspera.remove();
